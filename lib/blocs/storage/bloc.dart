...
class StorageBloc extends Bloc<StorageEvent, StorageState> {
  ...
  StorageBloc(this._backupRepository, this._cacheRepository, Storage storage) : super(StorageState.copy(storage)) {
  ...
  void _onStorageChanged(StorageChanged event, Emitter<StorageState> emit) async {
    ...
    await _flushStorageToRepositories();
  }
  ...
  Future<void> _flushStorageToRepositories() async {
    final data = state.cast();
    await _cacheRepository.flushCache(data);
  }
